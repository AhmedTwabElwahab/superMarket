...
class SaleInvoiceRequest extends FormRequest
{
    ...
    protected function onUpdate(): array
    {
        return [
            ...
            'sale_price_new_'            => 'array|min:1',
            'sale_price_new_.*'          => 'required|numeric',
            ...
            'amount_paid'                => 'nullable|required_unless:payment_type_id,1|numeric',
    ...
    protected function onCreate(): array
    {
        return [
            ...
            'quantity_new_.*'            => 'required|numeric',
            'sale_price_new_'            => 'required|array|min:1',
            'sale_price_new_.*'          => 'required|numeric',
            'total_bill'                 => 'required|numeric',
            'notes'                      => 'sometimes|nullable|string',
        ];
