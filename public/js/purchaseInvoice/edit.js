...
function balance()
{
    ...
    let Debit   = Number(supplier.find(":selected").data('accountd'));
    let Credit  = Number(supplier.find(":selected").data('accountc'));
...
$(document).ready(function()
{
    ...
    function Search()
    {
        ...
        $("#purchaseInvoice tr").filter(function()
        {
    ...
    $(document).on('click','.btn-add',function ()
    {
        ...
        let n = $( "tr" ).length;
        $('#purchaseInvoice').find('tbody').append(
    ...
    $('#purchaseInvoice').on('click','tbody tr td button#remove_row',function ()
    {
