...
@section('content')
    ...
    <div class="row">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{$lang->text('add_category')}}</li>
            </ol>
        </nav>
    </div>
    <div class="row container-body p-3">
        ...
        <form class="form" id ='Createcategory' action="{{route('category.store')}}"
                method="POST"
    ...
    <div class="row mt-4">
        <div class="form-group col-md-2">
            <button type="submit" form ="Createcategory" class="btn btn-primary">
                {{$lang->text('save')}}
            </button>
        </div>
    </div>{{--end of row--}}
